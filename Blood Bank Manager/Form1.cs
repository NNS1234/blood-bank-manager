...
namespace Blood_Bank_Manager {
    public partial class MainForm : Form {
        public MainForm() {
            ...
            change_menu_button_color(home_button);
            load_HomeUC();
        }
        ...
        void menu_button_list_initialize() {
            ...
            menu_buttons.Add(about_us_button);
        }
        void change_menu_button_color(object sender) {
            foreach (Button button in menu_buttons) {
                button.BackColor = Color.FromArgb(30,69,167);
            }
            (sender as Button).BackColor = Color.FromArgb(109,133,193);
        }
        ...
        private void load_AboutUsUC() {
            if (!base_panel.Controls.Contains(AboutUsUC.Instance)) {
                base_panel.Controls.Add(AboutUsUC.Instance);
                AboutUsUC.Instance.Dock = DockStyle.Fill;
            }
            AboutUsUC.Instance.BringToFront();
        }
    }
}
